        ...
        <Box sx={{ my: 2 }}>
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12 }}>
              <CippFormComponent
                type="checkbox"
                label="I understand that by pressing submit this license will be purchased according to the terms and conditions for this SKU with your configured CSP provider."
                name="iagree"
                formControl={formControl}
                validators={{
                  required: "This field is required.",
